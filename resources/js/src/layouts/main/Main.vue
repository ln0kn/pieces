...
<template>
    <div class="layout--main" id="siedB" :class="[layoutTypeClass, navbarClasses, footerClasses, {'no-scroll': isAppPage}]">
                    ...
                    <div class="router-content">
                        ...
                        <div class="content-area__content">
                            ...
                            <transition :name="routerTransition" mode="out-in">
                                <router-view :key="$route.fullPath" @changeRouteTitle="changeRouteTitle" @setAppClasses="(classesStr) => $emit('setAppClasses', classesStr)" />
                            </transition>
                        </div>
                    </div>
                </div>
